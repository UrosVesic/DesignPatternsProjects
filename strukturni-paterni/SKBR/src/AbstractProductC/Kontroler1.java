...
import ConcreteImplementor.DKSkiKarta;
...
public class Kontroler1 extends Kontroler{
    ...
    {javax.swing.JButton Kreiraj = ef.getPanel().getKreiraj();
     ...
     javax.swing.JTextField SifraSkiKarte = ef.getPanel().getSifraSkiKarte1(); // Promenljivo!!!
     SifraSkiKarte.addFocusListener( new OsluskivacNadji1(this));
    }
