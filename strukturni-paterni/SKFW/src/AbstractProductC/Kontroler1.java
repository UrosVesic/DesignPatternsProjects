...
// Promenljivo!!!
    ...
    boolean zapamtiDomenskiObjekat() {
        ...
        prikaziPoruku();
        bbp.closeConnection();
        lg.dodajLog("zapamtiDomenskiObjekat",sk,poruka);
        return signal;
    ...
    boolean kreirajDomenskiObjekat() {
        ...
        prikaziPoruku();
        bbp.closeConnection();
        lg.dodajLog("kreirajDomenskiObjekat",sk,poruka);
        return signal;
    }
    ...
    boolean obrisiDomenskiObjekat() {
        ...
        prikaziPoruku();
        bbp.closeConnection();
        lg.dodajLog("obrisiDomenskiObjekat",sk,poruka);
        return signal;
    }
    ...
    boolean promeniDomenskiObjekat() {
        ...
        prikaziPoruku();
        bbp.closeConnection();
        lg.dodajLog("promeniDomenskiObjekat",sk,poruka);
        return signal;
    }
    ...
    boolean nadjiDomenskiObjekat() {
        ...
        prikaziPoruku();
        bbp.closeConnection();
        lg.dodajLog("nadjiDomenskiObjekat",sk,poruka);
        return signal;
    }
