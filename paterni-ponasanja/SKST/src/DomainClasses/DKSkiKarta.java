...
public class DKSkiKarta implements Serializable, GeneralDObject {
    ...
    public DKSkiKarta(int sifraSkiKarte, String imePrezimeKupca, double cena, int sifraSkiCentra, Date datumIzdavanja, String Stanje) {
    ...
    public String getAtrValue() {
        return sifraSkiKarte + ", " + (imePrezimeKupca == null ? null : "'" + imePrezimeKupca + "'") + ", " + cena + ", " + sifraSkiCentra + ", " + "'" + datumIzdavanja + "'" + ", " + (stanje == null ? null : "'" + stanje + "'");
    }

    @Override
    public String setAtrValue() {
        return "sifraSkiKarte=" + sifraSkiKarte + ", " + "imePrezimeKupca=" + (imePrezimeKupca == null ? null : "'" + imePrezimeKupca + "'") + ", " + "cena=" + cena + ", " + "sifraSkiCentra=" + sifraSkiCentra + ", " + "datumizdavanja=" + "'" + datumIzdavanja + "'" + ", " + "stanje = " + (stanje == null ? null : "'" + stanje + "'");
    }
    ...
    public GeneralDObject getNewRecord(ResultSet rs) throws SQLException {
        return new DKSkiKarta(rs.getInt("sifraSkiKarte"), rs.getString("imePrezimeKupca"), rs.getInt("cena"), rs.getInt("sifraSkiCentra"), new Date(rs.getDate("datumIzdavanja").getTime()), rs.getString("Stanje"));
    }
